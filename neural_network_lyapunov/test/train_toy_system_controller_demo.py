...
if __name__ == "__main__":
    ...
    if args.dimension == 1:
        ...
        params = torch.tensor([
            1, -1, -1, 2, 0.5, 0.5, -2, 1, 0.5, -0.5, -1, 1, 1, -1, 2, -2, 0.5
        ],
                              dtype=torch.float64)
    ...
    forward_relu = utils.setup_relu(linear_layer_width,
                                    params=params,
                                    negative_slope=0.01,
                                    bias=True,
                                    dtype=torch.float64)
    ...
    V_lambda = 0.1
    controller_relu = utils.setup_relu(controller_linear_layer_width,
                                       params=None,
                                       negative_slope=0.01,
                                       bias=True,
                                       dtype=torch.float64)
    lyapunov_relu = utils.setup_relu(lyapunov_linear_layer_width,
                                     params=None,
                                     negative_slope=0.01,
                                     bias=True,
                                     dtype=torch.float64)
