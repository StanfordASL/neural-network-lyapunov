...
class DoublePendulum(nonlinear_system.NonlinearSystem):
    def __init__(self, dtype):
        ...
        self.u_lo = [torch.Tensor([-100., -100.]).type(dtype)]
        self.u_up = [torch.Tensor([100., 100.]).type(dtype)]
        self.g = 9.81
        self.x_dim = [4]
        self.u_dim = [2]
